...
function CheckLevel()
    ...
    if Third_Sea then
        ...
        elseif Lv == 2575 or Lv <= 2599 or _G.SelectMonster == "Skull Slayer [Lv. 2575]" then
            Ms = "Skull Slayer"
            NameQuest = "TikiQuest3"
            QuestLv = 2
            ...
            CFrameQ = CFrame.new(-16665.1914, 104.596405, 1579.69434, 0.951068401, -0, -0.308980465, 0, 1, -0, 0.308980465, 0, 0.951068401)
            CFrameMon = CFrame.new(-16654.7754, 105.286232, 1579.67444, 0.999096751, 4.45934489e-08, 0.0424928814, -4.38822667e-08, 1, -1.76692847e-08, -0.0424928814, 1.57886415e-08, 0.999096751)
        elseif Lv == 2600 or Lv <= 2624 or _G.SelectMonster == "Reef Bandit [Lv. 2600]" then
            Ms = "Reef Bandit"
        ...
        elseif Lv == 2625 or Lv <= 2649 or _G.SelectMonster == "Coral Pirate [Lv. 2625]" then
            Ms = "Coral Pirate"
            NameQuest = "SubmergedQuest1"
            QuestLv = 2
        ...
        elseif Lv == 2650 or Lv <= 2674 or _G.SelectMonster == "Sea Chanter [Lv. 2650]" then
            Ms = "Sea Chanter"
        ...
        elseif Lv == 2675 or Lv <= 2699 or _G.SelectMonster == "Ocean Prophet [Lv. 2675]" then
            Ms = "Ocean Prophet"
            NameQuest = "SubmergedQuest2"
            QuestLv = 2
