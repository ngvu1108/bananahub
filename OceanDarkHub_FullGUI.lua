...
local Window = Library:CreateWindow('Ducvu / Ver_1')
...
Changelog:addChangelog('Menu : Đức Vũ' )
Changelog:addChangelog('Thông Tin Liên Hệ')
Changelog:addChangelog('YTB: ...')
Changelog:addChangelog('Tik Tok: @ng.dvuu')
Changelog:addChangelog('FB : @Nguyễn Đức Vũ')
...
function CheckLevel()
    ...
    if First_Sea then
        if (Lv >= 1 and Lv <= 9) or _G.SelectMonster == "Bandit [Lv. 5]" then -- Bandit
            Ms = "Bandit"
        ...
        elseif (Lv >= 10 and Lv <= 14) or _G.SelectMonster == "Monkey [Lv. 14]" then -- Monkey
            Ms = "Monkey"
        ...
        elseif (Lv >= 15 and Lv <= 29) or _G.SelectMonster == "Gorilla [Lv. 20]" then -- Gorilla
            Ms = "Gorilla"
            NameQuest = "JungleQuest"
            QuestLv = 2
            NameMon = "Gorilla"
        ...
        elseif (Lv >= 30 and Lv <= 39) or _G.SelectMonster == "Pirate [Lv. 35]" then -- Pirate
            Ms = "Pirate"
        ...
        elseif (Lv >= 40 and Lv <= 59) or _G.SelectMonster == "Brute [Lv. 45]" then -- Brute
            Ms = "Brute"
            NameQuest = "BuggyQuest1"
            QuestLv = 2
            NameMon = "Brute"
        ...
        elseif (Lv >= 60 and Lv <= 74) or _G.SelectMonster == "Desert Bandit [Lv. 60]" then -- Desert Bandit
            Ms = "Desert Bandit"
        ...
        elseif (Lv >= 75 and Lv <= 89) or _G.SelectMonster == "Desert Officer [Lv. 70]" then -- Desert Officer
            Ms = "Desert Officer"
            NameQuest = "DesertQuest"
            QuestLv = 2
        ...
        elseif (Lv >= 90 and Lv <= 99) or _G.SelectMonster == "Snow Bandit [Lv. 90]" then -- Snow Bandit
            Ms = "Snow Bandit"
            NameQuest = "SnowQuest"
            QuestLv = 1
            NameMon = "Snow Bandit"
        ...
        elseif (Lv >= 100 and Lv <= 119) or _G.SelectMonster == "Snowman [Lv. 100]" then -- Snowman
            Ms = "Snowman"
            NameQuest = "SnowQuest"
            QuestLv = 2
            NameMon = "Snowman"
        ...
        elseif (Lv >= 120 and Lv <= 149) or _G.SelectMonster == "Chief Petty Officer [Lv. 120]" then -- Chief Petty Officer
        ...
        elseif (Lv >= 150 and Lv <= 174) or _G.SelectMonster == "Sky Bandit [Lv. 150]" then -- Sky Bandit
            Ms = "Sky Bandit"
            NameQuest = "SkyQuest"
            QuestLv = 1
            NameMon = "Sky Bandit"
        ...
        elseif (Lv >= 175 and Lv <= 189) or _G.SelectMonster == "Dark Master [Lv. 175]" then -- Dark Master
            Ms = "Dark Master"
            NameQuest = "SkyQuest"
            QuestLv = 2
            NameMon = "Dark Master"
        ...
        elseif (Lv >= 190 and Lv <= 209) or _G.SelectMonster == "Prisoner [Lv. 190]" then -- Prisoner
            Ms = "Prisoner"
        ...
        elseif (Lv >= 210 and Lv <= 249) or _G.SelectMonster == "Dangerous Prisoner [Lv. 210]" then -- Dangerous Prisoner
        ...
        elseif (Lv >= 250 and Lv <= 274) or _G.SelectMonster == "Toga Warrior [Lv. 250]" then -- Toga Warrior
            Ms = "Toga Warrior"
        ...
        elseif (Lv >= 275 and Lv <= 299) or _G.SelectMonster == "Gladiator [Lv. 275]" then -- Gladiator
            Ms = "Gladiator"
            NameQuest = "ColosseumQuest"
            QuestLv = 2
            NameMon = "Gladiator"
        ...
        elseif (Lv >= 300 and Lv <= 324) or _G.SelectMonster == "Military Soldier [Lv. 300]" then -- Military Soldier
            Ms = "Military Soldier"
        ...
        elseif (Lv >= 325 and Lv <= 374) or _G.SelectMonster == "Military Spy [Lv. 325]" then -- Military Spy
            Ms = "Military Spy"
            NameQuest = "MagmaQuest"
            QuestLv = 2
        ...
        elseif (Lv >= 375 and Lv <= 399) or _G.SelectMonster == "Fishman Warrior [Lv. 375]" then -- Fishman Warrior 
            Ms = "Fishman Warrior"
        ...
        elseif (Lv >= 400 and Lv <= 449) or _G.SelectMonster == "Fishman Commando [Lv. 400]" then -- Fishman Commando
            Ms = "Fishman Commando"
            NameQuest = "FishmanQuest"
            QuestLv = 2
        ...
        elseif (Lv >= 450 and Lv <= 474) or _G.SelectMonster == "God's Guard [Lv. 450]" then -- God's Guard
            Ms = "God's Guard"
        ...
        elseif (Lv >= 475 and Lv <= 524) or _G.SelectMonster == "Shanda [Lv. 475]" then -- Shanda
            Ms = "Shanda"
            NameQuest = "SkyExp1Quest"
            QuestLv = 2
            NameMon = "Shanda"
        ...
        elseif (Lv >= 525 and Lv <= 549) or _G.SelectMonster == "Royal Squad [Lv. 525]" then -- Royal Squad
            Ms = "Royal Squad"
        ...
        elseif (Lv >= 550 and Lv <= 624) or _G.SelectMonster == "Royal Soldier [Lv. 550]" then -- Royal Soldier
            Ms = "Royal Soldier"
            NameQuest = "SkyExp2Quest"
            QuestLv = 2
        ...
        elseif (Lv >= 625 and Lv <= 649) or _G.SelectMonster == "Galley Pirate [Lv. 625]" then -- Galley Pirate
            Ms = "Galley Pirate"
    ...
    if Second_Sea then
        if (Lv >= 700 and Lv <= 724) or _G.SelectMonster == "Raider [Lv. 700]" then -- Raider
            Ms = "Raider"
        ...
        elseif (Lv >= 725 and Lv <= 774) or _G.SelectMonster == "Mercenary [Lv. 725]" then -- Mercenary
            Ms = "Mercenary"
            NameQuest = "Area1Quest"
            QuestLv = 2
            NameMon = "Mercenary"
        ...
        elseif (Lv >= 775 and Lv <= 799) or _G.SelectMonster == "Swan Pirate [Lv. 775]" then -- Swan Pirate
            Ms = "Swan Pirate"
        ...
        elseif (Lv >= 800 and Lv <= 874) or _G.SelectMonster == "Factory Staff [Lv. 800]" then -- Factory Staff
            Ms = "Factory Staff"
            NameQuest = "Area2Quest"
            QuestLv = 2
        ...
        elseif (Lv >= 875 and Lv <= 899) or _G.SelectMonster == "Marine Lieutenant [Lv. 875]" then -- Marine Lieutenant
        ...
        elseif (Lv >= 900 and Lv <= 949) or _G.SelectMonster == "Marine Captain [Lv. 900]" then -- Marine Captain
            Ms = "Marine Captain"
            NameQuest = "MarineQuest3"
            QuestLv = 2
        ...
        elseif (Lv >= 950 and Lv <= 974) or _G.SelectMonster == "Zombie [Lv. 950]" then -- Zombie
            Ms = "Zombie"
        ...
        elseif (Lv >= 975 and Lv <= 999) or _G.SelectMonster == "Vampire [Lv. 975]" then -- Vampire
            Ms = "Vampire"
            NameQuest = "ZombieQuest"
            QuestLv = 2
            NameMon = "Vampire"
        ...
        elseif (Lv >= 1000 and Lv <= 1049) or _G.SelectMonster == "Snow Trooper [Lv. 1000]" then -- Snow Trooper
            Ms = "Snow Trooper"
        ...
        elseif (Lv >= 1050 and Lv <= 1099) or _G.SelectMonster == "Winter Warrior [Lv. 1050]" then -- Winter Warrior
            Ms = "Winter Warrior"
            NameQuest = "SnowMountainQuest"
            QuestLv = 2
        ...
        elseif (Lv >= 1100 and Lv <= 1124) or _G.SelectMonster == "Lab Subordinate [Lv. 1100]" then -- Lab Subordinate
            Ms = "Lab Subordinate"
        ...
        elseif (Lv >= 1125 and Lv <= 1174) or _G.SelectMonster == "Horned Warrior [Lv. 1125]" then -- Horned Warrior
            Ms = "Horned Warrior"
            NameQuest = "IceSideQuest"
            QuestLv = 2
        ...
        elseif (Lv >= 1175 and Lv <= 1199) or _G.SelectMonster == "Magma Ninja [Lv. 1175]" then -- Magma Ninja
            Ms = "Magma Ninja"
        ...
        elseif (Lv >= 1200 and Lv <= 1249) or _G.SelectMonster == "Lava Pirate [Lv. 1200]" then -- Lava Pirate
            Ms = "Lava Pirate"
            NameQuest = "FireSideQuest"
            QuestLv = 2
            NameMon = "Lava Pirate"
        ...
        elseif (Lv >= 1250 and Lv <= 1274) or _G.SelectMonster == "Ship Deckhand [Lv. 1250]" then -- Ship Deckhand
            Ms = "Ship Deckhand"
        ...
        elseif (Lv >= 1275 and Lv <= 1299) or _G.SelectMonster == "Ship Engineer [Lv. 1275]" then -- Ship Engineer
            Ms = "Ship Engineer"
            NameQuest = "ShipQuest1"
            QuestLv = 2
        ...
        elseif (Lv >= 1300 and Lv <= 1324) or _G.SelectMonster == "Ship Steward [Lv. 1300]" then -- Ship Steward
            Ms = "Ship Steward"
        ...
        elseif (Lv >= 1325 and Lv <= 1349) or _G.SelectMonster == "Ship Officer [Lv. 1325]" then -- Ship Officer
            Ms = "Ship Officer"
            NameQuest = "ShipQuest2"
            QuestLv = 2
        ...
        elseif (Lv >= 1350 and Lv <= 1374) or _G.SelectMonster == "Arctic Warrior [Lv. 1350]" then -- Arctic Warrior
            Ms = "Arctic Warrior"
        ...
        elseif (Lv >= 1375 and Lv <= 1424) or _G.SelectMonster == "Snow Lurker [Lv. 1375]" then -- Snow Lurker
            Ms = "Snow Lurker"
            NameQuest = "FrostQuest"
            QuestLv = 2
            NameMon = "Snow Lurker"
        ...
        elseif (Lv >= 1425 and Lv <= 1449) or _G.SelectMonster == "Sea Soldier [Lv. 1425]" then -- Sea Soldier
            Ms = "Sea Soldier"
    ...
    if Third_Sea then
        if (Lv >= 1500 and Lv <= 1524) or _G.SelectMonster == "Pirate Millionaire [Lv. 1500]" then -- Pirate Millionaire
        ...
        elseif (Lv >= 1525 and Lv <= 1574) or _G.SelectMonster == "Pistol Billionaire [Lv. 1525]" then -- Pistol Billionaire
        ...
        elseif (Lv >= 1575 and Lv <= 1599) or _G.SelectMonster == "Dragon Crew Warrior [Lv. 1575]" then -- Dragon Crew Warrior
        ...
        elseif (Lv >= 1600 and Lv <= 1624) or _G.SelectMonster == "Dragon Crew Archer [Lv. 1600]" then -- Dragon Crew Archer
        ...
        elseif (Lv >= 1625 and Lv <= 1649) or _G.SelectMonster == "Female Islander [Lv. 1625]" then -- Female Islander
            Ms = "Female Islander"
        ...
        elseif (Lv >= 1650 and Lv <= 1699) or _G.SelectMonster == "Giant Islander [Lv. 1650]" then -- Giant Islander
            Ms = "Giant Islander"
            NameQuest = "AmazonQuest2"
            QuestLv = 2
        ...
        elseif (Lv >= 1700 and Lv <= 1724) or _G.SelectMonster == "Marine Commodore [Lv. 1700]" then -- Marine Commodore
            Ms = "Marine Commodore"
        ...
        elseif (Lv >= 1725 and Lv <= 1774) or _G.SelectMonster == "Marine Rear Admiral [Lv. 1725]" then -- Marine Rear Admiral
        ...
        elseif (Lv >= 1775 and Lv <= 1799) or _G.SelectMonster == "Fishman Raider [Lv. 1775]" then -- Fishman Raider
            Ms = "Fishman Raider"
        ...
        elseif (Lv >= 1800 and Lv <= 1824) or _G.SelectMonster == "Fishman Captain [Lv. 1800]" then -- Fishman Captain
            Ms = "Fishman Captain"
            NameQuest = "DeepForestIsland3"
            QuestLv = 2
        ...
        elseif (Lv >= 1825 and Lv <= 1849) or _G.SelectMonster == "Forest Pirate [Lv. 1825]" then -- Forest Pirate
            Ms = "Forest Pirate"
        ...
        elseif (Lv >= 1850 and Lv <= 1899) or _G.SelectMonster == "Mythological Pirate [Lv. 1850]" then -- Mythological Pirate
        ...
        elseif (Lv >= 1900 and Lv <= 1924) or _G.SelectMonster == "Jungle Pirate [Lv. 1900]" then -- Jungle Pirate
            Ms = "Jungle Pirate"
        ...
        elseif (Lv >= 1925 and Lv <= 1974) or _G.SelectMonster == "Musketeer Pirate [Lv. 1925]" then -- Musketeer Pirate
            Ms = "Musketeer Pirate"
            NameQuest = "DeepForestIsland2"
            QuestLv = 2
        ...
        elseif (Lv >= 1975 and Lv <= 1999) or _G.SelectMonster == "Reborn Skeleton [Lv. 1975]" then
            Ms = "Reborn Skeleton"
        ...
        elseif (Lv >= 2000 and Lv <= 2024) or _G.SelectMonster == "Living Zombie [Lv. 2000]" then
            Ms = "Living Zombie"
            NameQuest = "HauntedQuest1"
            QuestLv = 2
        ...
        elseif (Lv >= 2025 and Lv <= 2049) or _G.SelectMonster == "Demonic Soul [Lv. 2025]" then
            Ms = "Demonic Soul"
        ...
        elseif (Lv >= 2050 and Lv <= 2074) or _G.SelectMonster == "Posessed Mummy [Lv. 2050]" then
            Ms = "Posessed Mummy"
            NameQuest = "HauntedQuest2"
            QuestLv = 2
        ...
        elseif (Lv >= 2075 and Lv <= 2099) or _G.SelectMonster == "Peanut Scout [Lv. 2075]" then
            Ms = "Peanut Scout"
        ...
        elseif (Lv >= 2100 and Lv <= 2124) or _G.SelectMonster == "Peanut President [Lv. 2100]" then
            Ms = "Peanut President"
            NameQuest = "NutsIslandQuest"
            QuestLv = 2
            ...
            CFrameQ = CFrame.new(-2105.53198, 37.2495995, -10195.5088, -0.766061664, 0, -0.642767608, 0, 1, 0, 0.642767608, 0, -0.766061664)
            CFrameMon = CFrame.new(-2150.587890625, 122.49767303467, -10358.994140625)
        elseif (Lv >= 2125 and Lv <= 2149) or _G.SelectMonster == "Ice Cream Chef [Lv. 2125]" then
            Ms = "Ice Cream Chef"
        ...
        elseif (Lv >= 2150 and Lv <= 2199) or _G.SelectMonster == "Ice Cream Commander [Lv. 2150]" then
            ...
            CFrameQ = CFrame.new(-819.376709, 64.9259796, -10967.2832, -0.766061664, 0, 0.642767608, 0, 1, 0, -0.642767608, 0, -0.766061664)
            CFrameMon = CFrame.new(-789.941528, 209.382889, -11009.9805, -0.0703101531, -0, -0.997525156, -0, 1.00000012, -0, 0.997525275, 0, -0.0703101456)
        elseif (Lv >= 2200 and Lv <= 2224) or _G.SelectMonster == "Cookie Crafter [Lv. 2200]" then
            Ms = "Cookie Crafter"
        ...
        elseif (Lv >= 2225 and Lv <= 2249) or _G.SelectMonster == "Cake Guard [Lv. 2225]" then
            Ms = "Cake Guard"
            NameQuest = "CakeQuest1"
            QuestLv = 2
            NameMon = "Cake Guard"
        ...
        elseif (Lv >= 2250 and Lv <= 2274) or _G.SelectMonster == "Baking Staff [Lv. 2250]" then
            Ms = "Baking Staff"
        ...
        elseif (Lv >= 2275 and Lv <= 2299) or _G.SelectMonster == "Head Baker [Lv. 2275]" then
            Ms = "Head Baker"
            NameQuest = "CakeQuest2"
            QuestLv = 2
            NameMon = "Head Baker"
        ...
        elseif (Lv >= 2300 and Lv <= 2324) or _G.SelectMonster == "Cocoa Warrior [Lv. 2300]" then
            Ms = "Cocoa Warrior"
        ...
        elseif (Lv >= 2325 and Lv <= 2349) or _G.SelectMonster == "Chocolate Bar Battler [Lv. 2325]" then
        ...
        elseif (Lv >= 2350 and Lv <= 2374) or _G.SelectMonster == "Sweet Thief [Lv. 2350]" then
            Ms = "Sweet Thief"
        ...
        elseif (Lv >= 2375 and Lv <= 2400) or _G.SelectMonster == "Candy Rebel [Lv. 2375]" then
            Ms = "Candy Rebel"
            NameQuest = "ChocQuest2"
            QuestLv = 2
            NameMon = "Candy Rebel"
        ...
        elseif (Lv >= 2400 and Lv <= 2424) or _G.SelectMonster == "Candy Pirate [Lv. 2400]" then
            Ms = "Candy Pirate"
        ...
        elseif (Lv >= 2425 and Lv <= 2449) or _G.SelectMonster == "Snow Demon [Lv. 2425]" then
            Ms = "Snow Demon"
            NameQuest = "CandyQuest1"
            QuestLv = 2
            NameMon = "Snow Demon"
        ...
        elseif (Lv >= 2450 and Lv <= 2474) or _G.SelectMonster == "Isle Outlaw [Lv. 2450]" then
            Ms = "Isle Outlaw"
        ...
        elseif (Lv >= 2475 and Lv <= 2499) or _G.SelectMonster == "Island Boy [2475]" then
            Ms = "Island Boy"
            NameQuest = "TikiQuest1"
            QuestLv = 2
            NameMon = "Island Boy"
        ...
        elseif (Lv >= 2500 and Lv <= 2524) or _G.SelectMonster == "Sun-kissed Warrior [Lv. 2500]" then
        ...
        elseif (Lv >= 2525 and Lv <= 2549) or _G.SelectMonster == "Isle Champion [Lv. 2525]" then
            Ms = "Isle Champion"
            NameQuest = "TikiQuest2"
            QuestLv = 2
        ...
        elseif (Lv >= 2550 and Lv <= 2574) or _G.SelectMonster == "Serpent Hunter [Lv. 2550]" then
            Ms = "Serpent Hunter"
        ...
        elseif (Lv >= 2575 and Lv <= 2599) or _G.SelectMonster == "Skull Slayer [Lv. 2575]" then
            Ms = "Skull Slayer"
            NameQuest = "TikiQuest3"
            QuestLv = 2
            ...
            CFrameQ = CFrame.new(-16665.1914, 104.596405, 1579.69434, 0.951068401, -0, -0.308980465, 0, 1, -0, 0.308980465, 0, 0.951068401)
            CFrameMon = CFrame.new(-16654.7754, 105.286232, 1579.67444, 0.999096751, 4.45934489e-08, 0.0424928814, -4.38822667e-08, 1, -1.76692847e-08, -0.0424928814, 1.57886415e-08, 0.999096751)
        elseif (Lv >= 2600 and Lv <= 2624) or _G.SelectMonster == "Reef Bandit [Lv. 2600]" then
            Ms = "Reef Bandit"
            NameQuest = "SubmergedQuest1"
            QuestLv = 1
            NameMon = "Reef Bandit"
            CFrameQ = CFrame.new(10779.6943359375, -2007.490478515625, 9262.912109375)
            CFrameMon = CFrame.new(10965.779296875, -2149.95849609375, 9254.869140625)
        elseif (Lv >= 2625 and Lv <= 2649) or _G.SelectMonster == "Coral Pirate [Lv. 2625]" then
            Ms = "Coral Pirate"
            NameQuest = "SubmergedQuest1"
            QuestLv = 2
        ...
        elseif (Lv >= 2675 and Lv <= 2699) or _G.SelectMonster == "Ocean Prophet [Lv. 2675]" then
            ...
            CFrameMon = CFrame.new(11025.0546875, -2081.28204980375, 10142.8828046875)
        elseif (Lv >= 2700 and Lv <= 2724) or _G.SelectMonster == "High Disciple [Lv. 2700]" then -- High Disciple
            Ms = "High Disciple"
            NameQuest = "SubmergedQuest3"
            QuestLv = 1
            NameMon = "High Disciple"
            CFrameQ = CFrame.new(9641.03515625, -1992.2191162109375, 9614.7265625)
            CFrameMon = CFrame.new(11025.0546875, -2081.2822265625, 10142.8828125)
        elseif Lv >= 2725 or _G.SelectMonster == "Grand Devotee [Lv. 2725]" then -- Grand Devotee
            Ms = "Grand Devotee"
            NameQuest = "SubmergedQuest3"
            QuestLv = 2
...
DisFarm = 55
-- === bump DisFarm to 100 for 3s only when server call has args[1]=="TAP" and contains a Vector3 ===
do
    ...
    mt.__namecall = newcclosure(function(self, ...)
        ...
        if (method == "FireServer" or method == "InvokeServer") and args[1] == "TAP" then
            ...
            for i = 1, #args do
                ...
                if type(a) == "userdata" and tostring(a):find("Vector3") then
                    hasVector3 = true
                    break
                end
            end

            if hasVector3 and not _G.__DisFarmVecDebounce then
                _G.__DisFarmVecDebounce = true
                local prev = tonumber(DisFarm) or 55
                DisFarm = 100
                if AutoFarmType == "Above" then
                    Farm_Mode = CFrame.new(0, DisFarm, 0) * CFrame.Angles(math.rad(-90), 0, 0)
                else
...
--// Auto Activate V4
AutoV4 = false
Main_Setting:addToggle('Auto V4', AutoV4, function(Value)
    AutoV4 = Value
end)
spawn(function()
    while task.wait(0.1) do
        if AutoV4 then
            pcall(function()
                ...
                if playerGui and playerGui:FindFirstChild("Main") and playerGui.Main:FindFirstChild("RaceEnergy") then
                    local raceEnergy = playerGui.Main.RaceEnergy
                    if raceEnergy:FindFirstChild("Fill") and raceEnergy.Fill:FindFirstChild("Trans") then
                        local trans = raceEnergy.Fill.Trans
                        if trans.Size.X.Scale >= 1 then
                            local vim = game:GetService("VirtualInputManager")
                            vim:SendKeyEvent(true, Enum.KeyCode.Y, false, game)
                            task.wait(0.1)
                            vim:SendKeyEvent(false, Enum.KeyCode.Y, false, game)
                            task.wait(1)  -- Wait a bit to avoid spamming if it doesn't reset immediately
                        end
                    end
                end
            end)
...
AutoV3 = false 
Main_Setting:addToggle('Auto V3', AutoV3, function(Value) 
    AutoV3 = Value
end)
...
local PrehistoricCheck = IslandInfo:addLabel("")
spawn(function()
    while task.wait() do
        if game.Workspace.Map:FindFirstChild("PrehistoricIsland") then
            PrehistoricCheck:Refresh("Prehistoric Island : Spawn")
        else
            PrehistoricCheck:Refresh("Prehistoric Island : Not Spawn")
        end
    end
end)
...
--// Prehistoric Island
local Prehistoric_Island = Race_V4_Left:addMenu('#Prehistoric Island')

Prehistoric_Island:addToggle("Teleport to Prehistoric", TeleporttoPrehistoric, function(Value)
    TeleporttoPrehistoric = Value
    CancelTween(TeleporttoPrehistoric)
end)
spawn(function()
    while task.wait() do
        if TeleporttoPrehistoric then
            if game.Workspace.Map:FindFirstChild("PrehistoricIsland") then
                local prehistoricIsland = game.Workspace.Map.PrehistoricIsland
                local pivotCFrame = prehistoricIsland:GetPivot()
                Tween(pivotCFrame)
            end
        end
    end
...
RaceV4_Area:addButton("Temple of Time", function()
    local pos = Vector3.new(28308, 14897, 138)   
    pcall(function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", pos)
    end)
    
    task.wait(1)
    TP2(CFrame.new(pos.X, pos.Y, pos.Z))
end)
...
--// HALLOWEEN EVENT AUTO FARM (FIXED VERSION)
local HalloweenEvent = Farm_Left:addMenu('#Halloween Event Auto Farm')

-- Toggle bật/tắt auto Halloween Event
HalloweenEvent:addToggle('Auto Halloween Event', _G.AutoHalloweenEvent, function(Value)
    _G.AutoHalloweenEvent = Value
    if not Value then
        CancelTween(_G.AutoHalloweenEvent)
        IsInRoom = false
    end
end)

-- Toggle bật/tắt auto Gacha
HalloweenEvent:addToggle('Auto Gacha', _G.AutoGacha, function(Value)
    _G.AutoGacha = Value
end)

-- Danh sách các Halloween Door và monster
local HalloweenDoors = {}
local Vampire = "Vampire"
local CursedSkeleton = "Cursed Skeleton" 
local OniSoldier = "Oni Soldier"
local Snowman = "Snowman"
local Gorilla = "Gorilla"
local CelestialSoldier = "Celestial Soldier"
local RipReturn = "rip_return"
local WerewolfBoss = "Unbound Werewolf [Lv. 3000] [Raid Boss]"

-- Biến theo dõi
local LastHealth = {}
local NoDamageTimer = {}
local MaxNoDamageTime = 10
local CurrentDoorIndex = 1
local IsInRoom = false
local IsAttacking = false
local LastDoorUsed = nil

-- Function tìm tất cả Halloween Door
local function FindHalloweenDoors()
    HalloweenDoors = {}
    
    -- Tìm trong Map/Turtle/IslandModel/HalloweenHotel
    local Map = game:GetService("Workspace"):FindFirstChild("Map")
    if Map then
        local Turtle = Map:FindFirstChild("Turtle")
        if Turtle then
            local IslandModel = Turtle:FindFirstChild("IslandModel")
            if IslandModel then
                local HalloweenHotel = IslandModel:FindFirstChild("HalloweenHotel")
                if HalloweenHotel then
                    for _, door in pairs(HalloweenHotel:GetDescendants()) do
                        if door.Name == "HalloweenDoor" and door:IsA("Model") and door:FindFirstChildWhichIsA("BasePart") then
                            table.insert(HalloweenDoors, door)
                        end
                    end
                end
            end
    ...
    print("🎃 Tìm thấy " .. #HalloweenDoors .. " cửa Halloween")
    return HalloweenDoors
end

-- Function kiểm tra character
...
-- Function teleport đến cửa và sử dụng remote
local function UseHalloweenDoor(door)
    pcall(function()
        if not CheckCharacter() then return false end
        
        print("🚪 Đang di chuyển đến cửa: " .. door.Name)
        
        -- Teleport đến cửa
        local humanoidRootPart = game.Players.LocalPlayer.Character.HumanoidRootPart
        local doorCFrame = door.PrimaryPart.CFrame
        local targetCFrame = CFrame.new(doorCFrame.Position + Vector3.new(0, 5, 0)) -- Đứng trên cửa
        ...
        repeat 
            ...
            timeout = timeout + 0.1
            if not CheckCharacter() then return false end
        until (humanoidRootPart.Position - doorCFrame.Position).Magnitude < 15 or timeout > 10
        
        if timeout > 10 then
            print("❌ Timeout khi di chuyển đến cửa")
            return false
        end
        
        -- Sử dụng remote để vào cửa
        local args = {
            [1] = door
        }
        local success = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("HalloweenFunction"):InvokeServer(unpack(args))
        
        if success then
            print("🚪 Đã sử dụng cửa Halloween thành công")
            LastDoorUsed = door
            IsInRoom = true
            return true
        else
            print("❌ Không thể vào cửa")
            return false
        end
    end)
    return false
...
-- Function nhận reward
local function AcceptReward()
    pcall(function()
        local args = {
            [1] = "AcceptReward"
        }
        game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("HalloweenEvent"):FireServer(unpack(args))
        print("🎁 Đã nhận thưởng")
    end)
end

-- Function nhận fruits
local function GetFruits()
    pcall(function()
        ...
        print("🍎 Đã nhận fruits")
    end)
end

-- Function kiểm tra damage (optimized)
local function CheckDamage(monster, monsterName)
    pcall(function()
        if not monster or not monster:FindFirstChild("Humanoid") then return false end
        
        if not NoDamageTimer[monsterName] then NoDamageTimer[monsterName] = 0 end
        if not LastHealth[monsterName] then
            LastHealth[monsterName] = monster.Humanoid.Health
            NoDamageTimer[monsterName] = 0
            return true
        end
        
        if monster.Humanoid.Health < LastHealth[monsterName] then
            LastHealth[monsterName] = monster.Humanoid.Health
            NoDamageTimer[monsterName] = 0
            return true
        else
            NoDamageTimer[monsterName] = NoDamageTimer[monsterName] + 0.5
            if NoDamageTimer[monsterName] >= MaxNoDamageTime then
                print("⚠️ Không gây được damage trong " .. MaxNoDamageTime .. "s - Tự động chuyển target!")
                LastHealth[monsterName] = nil
                NoDamageTimer[monsterName] = nil
                return false
            end
        end
        return true
...
-- Function tấn công quái thường (FIXED - không bị gián đoạn)
local function AttackHalloweenMonsters()
    pcall(function()
        if not CheckCharacter() then return false end
        ...
        for _, monsterName in pairs(monsters) do
            if not _G.AutoHalloweenEvent then break end
            
            local monster = game:GetService("Workspace").Enemies:FindFirstChild(monsterName)
            if monster and monster:FindFirstChild("Humanoid") and monster.Humanoid.Health > 0 and monster:FindFirstChild("HumanoidRootPart") then
                print("🎃 Đã phát hiện " .. monsterName .. " - Bắt đầu tấn công!")
                ...
                local lastMonsterPosition = monster.HumanoidRootPart.CFrame
                
                repeat
                    task.wait(0.1)
                    if not CheckCharacter() or not _G.AutoHalloweenEvent then break end
                    
                    -- Kiểm tra timeout (2 phút)
                    if tick() - attackStart > 120 then
                        print("⏰ Timeout - Chuyển target sau 2 phút")
                        break
                    end
                    
                    -- Cập nhật vị trí quái
                    if monster and monster:FindFirstChild("HumanoidRootPart") then
                        lastMonsterPosition = monster.HumanoidRootPart.CFrame
                    end
                    
                    -- Chỉ Tween nếu quái còn sống và ở gần
                    if monster and monster:FindFirstChild("Humanoid") and monster.Humanoid.Health > 0 then
                        EquipTool(SelectWeapon)
                        Tween(lastMonsterPosition * CFrame.new(0, 10, 0)) -- Đứng trên đầu quái
                        
                        -- Anti-leech và optimization
                        ...
                        -- Kiểm tra damage
                        if not CheckDamage(monster, monsterName) then
                            break
                        end
                    end
                    
                until not monster.Parent or not monster:FindFirstChild("Humanoid") or monster.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(monsterName)
                
                IsAttacking = false
                LastHealth[monsterName] = nil
                NoDamageTimer[monsterName] = nil
                
                -- Nhận thưởng sau khi tiêu diệt quái
                if monster and monster:FindFirstChild("Humanoid") and monster.Humanoid.Health <= 0 then
                    AcceptReward()
                    GetFruits()
                    wait(1)
...
-- Function tấn công boss Werewolf (FIXED)
local function AttackWerewolfBoss()
    pcall(function()
        if not CheckCharacter() then return false end
        
        local werewolf = game:GetService("Workspace").Enemies:FindFirstChild(WerewolfBoss)
        if not werewolf then
            werewolf = game:GetService("Workspace"):FindFirstChild(WerewolfBoss)
        end
        
        if werewolf and werewolf:FindFirstChild("Humanoid") and werewolf.Humanoid.Health > 0 and werewolf:FindFirstChild("HumanoidRootPart") then
            print("🐺 Đã phát hiện WereWolf Boss - Bắt đầu tấn công!")
            
            IsAttacking = true
            LastHealth[WerewolfBoss] = werewolf.Humanoid.Health
            NoDamageTimer[WerewolfBoss] = 0
            
            local attackStart = tick()
            local lastBossPosition = werewolf.HumanoidRootPart.CFrame
            
            repeat
                task.wait(0.1)
                if not CheckCharacter() or not _G.AutoHalloweenEvent then break end
                
                -- Kiểm tra timeout (3 phút cho boss)
                if tick() - attackStart > 180 then
                    print("⏰ Timeout boss - Chuyển target sau 3 phút")
                    break
                end
                
                -- Cập nhật vị trí boss
                if werewolf and werewolf:FindFirstChild("HumanoidRootPart") then
                    lastBossPosition = werewolf.HumanoidRootPart.CFrame
                end
                
                -- Chỉ Tween nếu boss còn sống
                if werewolf and werewolf:FindFirstChild("Humanoid") and werewolf.Humanoid.Health > 0 then
                    EquipTool(SelectWeapon)
                    Tween(lastBossPosition * CFrame.new(0, 15, 0)) -- Đứng trên đầu boss
                    
                    if werewolf:FindFirstChild("HumanoidRootPart") then
                        werewolf.HumanoidRootPart.CanCollide = false
                        werewolf.HumanoidRootPart.Size = Vector3.new(80,80,80)
                        werewolf.HumanoidRootPart.Transparency = 1
                    end
                    
                    AutoClick()
                    
                    if not CheckDamage(werewolf, WerewolfBoss) then
                        break
                    end
                end
                
            until not werewolf.Parent or not werewolf:FindFirstChild("Humanoid") or werewolf.Humanoid.Health <= 0
            
            IsAttacking = false
            LastHealth[WerewolfBoss] = nil
            NoDamageTimer[WerewolfBoss] = nil
            
            -- Nhận thưởng sau khi tiêu diệt boss
            if werewolf and werewolf:FindFirstChild("Humanoid") and werewolf.Humanoid.Health <= 0 then
                AcceptReward()
                GetFruits()
                wait(2)
...
-- Function Auto Gacha
local function AutoGachaFunction()
    pcall(function()
        local args = {
            [1] = "Cousin",
            [2] = "HalloweenGacha25"
...
-- Function chính cho Auto Halloween Event (COMPLETELY FIXED)
spawn(function()
    while task.wait(1) do
        if _G.AutoHalloweenEvent then
            pcall(function()
                ...
                -- Nếu đang tấn công thì không làm gì cả
                if IsAttacking then
                    return
                end
                ...
                if IsInRoom then
                    print("🔍 Đang trong phòng - Kiểm tra quái...")
                    
                    -- ƯU TIÊN 1: Kiểm tra và đánh boss WereWolf
                    if AttackWerewolfBoss() then
                        IsInRoom = false
                        wait(2)
                        return
                    end
                    
                    -- ƯU TIÊN 2: Kiểm tra và đánh quái thường
                    if AttackHalloweenMonsters() then
                        IsInRoom = false
                        wait(2)
                        return
                    end
                    
                    -- Nếu trong phòng nhưng không có quái, thoát phòng
                    print("🚪 Không có quái trong phòng - Thoát phòng")
                    IsInRoom = false
                    AcceptReward()
                    GetFruits()
                    wait(2)
                else
                    -- Ngoài phòng: tìm và vào cửa
                    print("🔍 Đang tìm cửa Halloween...")
                    local doors = FindHalloweenDoors()
                    
                    if #doors > 0 then
                        -- Chọn cửa tiếp theo (luân phiên tất cả cửa)
                        local door = doors[CurrentDoorIndex]
                        if door and door.Parent and door:FindFirstChildWhichIsA("BasePart") then
                            print("🚪 Đang thử cửa " .. CurrentDoorIndex .. "/" .. #doors)
                            
                            if UseHalloweenDoor(door) then
                                -- Chờ vào phòng và kiểm tra
                                wait(3)
                                
                                -- Chuyển sang cửa tiếp theo cho lần sau
                                CurrentDoorIndex = CurrentDoorIndex + 1
                                if CurrentDoorIndex > #doors then
                                    CurrentDoorIndex = 1
                                end
                            else
                                print("❌ Không thể vào cửa " .. CurrentDoorIndex .. ", thử cửa tiếp theo")
                                CurrentDoorIndex = CurrentDoorIndex + 1
                                if CurrentDoorIndex > #doors then
                                    CurrentDoorIndex = 1
                                end
                        ...
                        print("❌ Không tìm thấy cửa Halloween nào!")
                        wait(3)
                    end
                end
            end)
...
-- Reset state khi toggle off
HalloweenEvent:addToggle('Reset State', false, function(Value)
    if Value then
        IsInRoom = false
        IsAttacking = false
        CurrentDoorIndex = 1
        ...
        LastDoorUsed = nil
        CancelTween(_G.AutoHalloweenEvent)
        print("🔄 Đã reset trạng thái Halloween Event")
        wait(1)
        HalloweenEvent:getToggle('Reset State'):Set(false)
    end
end)

--// SELECT MONSTER (Giữ nguyên code gốc của bạn)
...
-- Add skill toggles here to fix the issue of not using skills
_G.SkillZ = true
_G.SkillX = true
_G.SkillC = true
_G.SkillV = true
...
Mastery_Farm:addToggle('Skill Z', _G.SkillZ, function(Value)
    _G.SkillZ = Value
end)
Mastery_Farm:addToggle('Skill X', _G.SkillX, function(Value)
    _G.SkillX = Value
end)
Mastery_Farm:addToggle('Skill C', _G.SkillC, function(Value)
    _G.SkillC = Value
end)
Mastery_Farm:addToggle('Skill V', _G.SkillV, function(Value)
    _G.SkillV = Value
end)
Mastery_Farm:addToggle('Skill F', _G.SkillF, function(Value)
    _G.SkillF = Value
end)
                    ...
                    if v.Name == Mastery_Farm_Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                        repeat game:GetService("RunService").Heartbeat:wait()
                            ...
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild(CurrentEquipDevilFruit) then
                                ...
                                local plr = game:GetService("Players").LocalPlayer
                                if _G.SkillZ and DevilFruitMastery >= 1 then -- Removed magnitude check to ensure skills are used
                                ...
                                if v.Name == Ms then
                                    repeat game:GetService("RunService").Heartbeat:wait()
                                        if v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                                            UseSkill = true
                                            Tween(v.HumanoidRootPart.CFrame * CFrame.new(0, 0, -5)) -- Tween closer to ensure skills trigger
                                        else
                                            UseSkill = false
                                            EquipTool(SelectWeapon)
                                            Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                    ...
                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                        if v.Name == Ms then
                            repeat game:GetService("RunService").Heartbeat:wait()
                                if v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                                    UseSkill = true
                                    Tween(v.HumanoidRootPart.CFrame * CFrame.new(0, 0, -5)) -- Tween closer
                                else
                                    UseSkill = false
                                    EquipTool(SelectWeapon)
                                    Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                    ...
                    if v.Name == Mastery_Farm_Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                        repeat game:GetService("RunService").Heartbeat:wait()
                            ...
                            if game:GetService("Players").LocalPlayer.Character:FindFirstChild(CurrentEquipGun) then
                                ...
                                local plr = game:GetService("Players").LocalPlayer
                                if _G.SkillZ and GunMastery >= 1 then -- Removed magnitude check
                                    game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
                                    wait(.1)
                                    game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
                                end
...
function AutoGrabChest()
    ...
    for i,v in pairs(game:GetService("Workspace").ChestModels:GetChildren()) do
        if v.Name == "SilverChest" or v.Name == "GoldChest" or v.Name == "DiamondChest" then
            local distance = (player.HumanoidRootPart.Position - v.PushBox.Position).Magnitude
            local speed = 100 -- Adjust speed as needed (studs per second)
            local time = math.max(0.1, distance / speed) -- Minimum time to avoid instant moves
            local tweenInfo = TweenInfo.new(time, Enum.EasingStyle.Linear)
            local tween = TweenService:Create(player.HumanoidRootPart, tweenInfo, {CFrame = v.PushBox.CFrame})
            tween:Play()
            ...
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.TopHUDList.RaidTimer.Visible == true then
                pcall(function()
                    ...
                    if locations:FindFirstChild("Island 5") then
                        currentIsland = locations["Island 5"]
                    elseif locations:FindFirstChild("Island 4") then
                        currentIsland = locations["Island 4"]
                    elseif locations:FindFirstChild("Island 3") then
                        currentIsland = locations["Island 3"]
                    elseif locations:FindFirstChild("Island 2") then
                        currentIsland = locations["Island 2"]
                    elseif locations:FindFirstChild("Island 1") then
                        currentIsland = locations["Island 1"]
                    end
                    if currentIsland then
                        local hasEnemy = false
                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                if (v.HumanoidRootPart.Position - currentIsland.Position).Magnitude <= 500 then
                                    hasEnemy = true
                                    repeat game:GetService("RunService").Heartbeat:wait()
                                        EquipTool(SelectWeaponRaid)
                                        Tween(v.HumanoidRootPart.CFrame * Farm_Mode)
                                        ...
                                        v.HumanoidRootPart.Size = Vector3.new(60,60,60)
                                        v.HumanoidRootPart.Transparency = 1
                                        Raid_Farm_Name = v.Name
                                        Raid_Farm_CFrame = v.HumanoidRootPart.CFrame
                                        AutoClick()
                                        sethiddenproperty(game:GetService('Players').LocalPlayer,"SimulationRadius",math.huge)
                                    until not RaidAura or not v.Parent or v.Humanoid.Health <= 0 or not game.Workspace.Enemies:FindFirstChild(v.Name)
                                end
                            end
                        end
                        if not hasEnemy then
                            Tween(currentIsland.CFrame * CFrame.new(0, DisRaid, 0))
                        end
                    end
                end)
            end
...
FightingShop:addButton("Sanguine Art [ $5,000 Fragments / $5,000,000 Beli ]", function()
...
DevilShop:addToggle("Auto Collect Fruits", _G.AutoCollectFruits, function(Value)
